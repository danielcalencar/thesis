	...
	\begin{threeparttable}
		\begin{tabular}{rp{1.7cm}lp{9.6cm}}
			...
			\begin{tabular}{p{9.5cm}}
				...
				given reporter are integrated quickly, future issues
				reported by the same reporter may also be integrated
				quickly. 
			\end{tabular}
			\\ \hline
			...
			\begin{tabular}{p{9.5cm}}
				...
				particular resolver were quickly integrated,
				future issues that are addressed by the same
				resolver may also be quickly integrated. 
			\end{tabular}
			\\ \hline
			...
			\begin{tabular}{p{9.5cm}}
				...
				thus, might be integrated more quickly than issues that are
			...
			\begin{tabular}{p{9.5cm}}
				...
				(\eg MS Windows) might be integrated more
			...
			\begin{tabular}{p{9.5cm}}
				...
				blocking) might be integrated faster than other issues.
			...
			\begin{tabular}{p{9.5cm}}
				...
				integrated before low priority issues. 
			\end{tabular}
			\\ \cline{2- 4}
			...
			\begin{tabular}{p{9.5cm}}
				...
				may quicken the integration of that addressed issue
	...
	\begin{threeparttable}
		\begin{tabular}{rp{2.3cm}lp{9cm}}
			...
			\begin{tabular}{p{8.9cm}}
				...
				the number of addressed issues that are integrated.
			\end{tabular}
			\\ \cline{ 2- 4}
			...
			\begin{tabular}{p{8.9cm}}
				...
				more likely to be quickly integrated.
			\end{tabular}                       
			\\ \hline
	...
	\begin{threeparttable}
		\begin{tabular}{rp{2.3cm}lp{9cm}}
			...
			\begin{tabular}{p{8.9cm}}
				...
				to fix the issue, which can impact the integration
				time of an issue.~\cite{Jiang2013}. 
			\end{tabular}
			\\ \cline{ 2- 4}
			...
			\begin{tabular}{p{8.9cm}}
				...
				easy to integrate, wich may quicken integration
				time. 
			\end{tabular}
			\\ \hline
		\end{tabular}
