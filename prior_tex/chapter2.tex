...
%	{chapters/chapter2/figures/rapid-cycle-crop.pdf} \caption{Releases built
%	into NIGHTLY channel are migrated to be stabilized into AURORA and BETA
%channels until it gets ready to be released into RELEASE channel.}
%\label{fig:rapid_cycle} \end{figure}
