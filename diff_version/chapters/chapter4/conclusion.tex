...
delivered. However, we observed that the \DIFdelbegin \DIFdel{integration }\DIFdelend \DIFaddbegin \DIFadd{delivery }\DIFaddend of several addressed issues
...
\\
	\begin{itemize}
		...
		\item train random forest models to model the \DIFdelbegin \DIFdel{integration
			time }\DIFdelend \DIFaddbegin \DIFadd{delivery
			delay }\DIFaddend of an addressed issue. Our models obtain a
...
integrators of software projects. It is important to improve the integration \DIFdelbegin \DIFdel{stage }\DIFdelend \DIFaddbegin \DIFadd{and
delivery stages }\DIFaddend of a release cycle, since the availability of an addressed issue
