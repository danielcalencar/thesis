...
A number of tools were developed in order to extract and analyze the \DIFdelbegin \DIFdel{integration
}\DIFdelend \DIFaddbegin \DIFadd{delivery
delay }\DIFaddend data in the studied projects. Defects in these tools could have an influence on
