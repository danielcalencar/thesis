...
%DIF < \subsection{Study 4---Why Do Delivery Delays Occur?}
%DIF < 
%DIF < In this study, we survey 37 developers from the Firefox, Eclipse, and ArgoUML projects to
%DIF < study the perceived impact of delivery delay and the shift from a traditional
%DIF < to a rapid release cycle. More specifically, we address the following research
%DIF < questions:
%DIF < 
%DIF < \begin{itemize}
%DIF < 
%DIF < 	\item \textbf{\textit{RQ4: What are developers' perceptions as to why
%DIF < 		delivery delays occur?}} The perceived reasons for
%DIF < 		the delivery delay of addressed issues are related to 
%DIF < 		decision making, team collaboration, and risk
%DIF < 		management activities. Moreover, delivery delay will likely lead to
%DIF < 		user/developer frustration according to our participants.\\
%DIF < 
%DIF < 	\item \textbf{\textit{RQ5: What are developers' perceptions of shifting
%DIF < 		to a rapid release cycle?}} The allure of delivering addressed
%DIF < 		issues more quickly to users is the most recurrent motivator of
%DIF < 		switching to a rapid release cycle. Moreover, the allure of
%DIF < 		improving the flexibility and quality of addressed issues is another
%DIF < 		advantage that are perceived by our participants.\\
%DIF < 
%DIF < 	\item \textbf{\textit{RQ6: To what extent do developers agree with our
%DIF < 		quantitative findings about delivery delay?}} The dependency
%DIF < 		of addressed issues on other projects and team workload are
%DIF < 		the main perceived explanations of our findings about
%DIF < 		delivery delay in general. Integration rush and increased
%DIF < 		time spent on polishing addressed issues (during rapid releases)
%DIF < 		emerge as main explanations as to why traditional releases may
%DIF < 		achieve shorter delivery delays. 
%DIF < \end{itemize}  
