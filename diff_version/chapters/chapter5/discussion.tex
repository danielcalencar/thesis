...
\noindent\DIFdelbegin \textit{\textbf{\DIFdel{Observation~8---The delivery delay of addressed issues is unlikely to be
related to the size of an issue.}}%DIFAUXCMD
}%DIFAUXCMD
%DIFDELCMD < \observation{obs:8}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \finding{The delivery delay of addressed issues is unlikely to be
...
\noindent\DIFdelbegin \textit{\textbf{\DIFdel{Observation~9---The difference between traditional and rapid releases
is unlikely to be related to the differences between enhancements and bug
fixes.}}%DIFAUXCMD
}%DIFAUXCMD
%DIFDELCMD < \observation{obs:9}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \finding{The difference between traditional and rapid releases
is unlikely to be related to the differences between enhancements and bug
fixes.}{find24}
...
of sufficient quality\DIFaddbegin \DIFadd{, which would impact on the time-to-delivery}\DIFaddend .
