...
\hyperref[st:study4]{Study}~\ref{st:study4}). We present the motivation \DIFdelbegin \DIFdel{of
performing }\DIFdelend \DIFaddbegin \DIFadd{for
conducting }\DIFaddend each study of this thesis in the subsections below.
...
%DIF > This was the first study that was conducted for this thesis, since we were
%DIF > interested on investigating  how frequent and how long are the delivery delays
%DIF > of addressed issues. In this study we use a quantitative approach for measuring
%DIF > the frequency of delivery delays.
\DIFaddbegin 

\DIFaddend \subsection{Study~2---Do rapid releases reduce delivery delays?}
...
analysis and {\em (ii)} verify \DIFdelbegin \DIFdel{to which extent }\DIFdelend \DIFaddbegin \DIFadd{whether }\DIFaddend our participants agree with our
findings from the quantitative studies. 

\DIFaddbegin \subsection{\DIFadd{Studies Chronology}}

\DIFadd{The arrows in }\hyperref[fig:thesis_overview]{Figure}\DIFadd{~\ref{fig:thesis_overview}
describes which study inspired the others.
}\hyperref[st:study1]{Study}\DIFadd{~\ref{st:study1} was the first to be
conducted in this thesis, since we were interested on investigating how
frequent and long are the delivery delays of addressed issues. After conducting
}\hyperref[st:study1]{Study}\DIFadd{~\ref{st:study1}, we observed a considerable
difference between the rapidly released Firefox and the other two studied
projects (}\ie \DIFadd{Eclipse and ArgoUML) regarding the frequency of delivery delays.
In our second study (}\hyperref[st:study3]{Study}\DIFadd{~\ref{st:study3}), we extended
our Firefox dataset in order to compare the traditional and rapid releases
regarding delivery delays. Such an investigation helps us on better understand
whether rapid releases may decrease delivery delays in terms of days. Finally,
both studies motivated us to perform
}\hyperref[st:study4]{Study}\DIFadd{~\ref{st:study4}. We use mixed methods to perform our
studies. As shown in
}\hyperref[fig:thesis_overview]{Figure}\DIFadd{~\ref{fig:thesis_overview}, we use
quantitative analyses in }\hyperref[st:study1]{Studies}\DIFadd{~\ref{st:study1}
and~\ref{st:study3} (}\ie \DIFadd{statistics and machine learning techniques). On the
other hand, }\hyperref[st:study4]{Study}\DIFadd{~\ref{st:study4} is mainly qualitative,
}\ie \DIFadd{we use surveys and interviews to obtain our data (although we perform some
quantitative analysis as well).
}

\DIFaddend \section{Thesis Contributions}
...
\begin{itemize}
	...
	\item Despite being addressed well before an upcoming release, 34\% to
		...
		of the Firefox project issues had their \DIFdelbegin \DIFdel{integration }\DIFdelend \DIFaddbegin \DIFadd{delivery }\DIFaddend delayed by
...
\begin{itemize}
	...
	\item The total time that is spent from the issue report date to its
		\DIFdelbegin \DIFdel{integration }\DIFdelend \DIFaddbegin \DIFadd{delivery }\DIFaddend into a release is not significantly different
